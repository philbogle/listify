...
1.  **Primary Task: Handwritten List Extraction**
    ...
    *   If a handwritten list is clearly identifiable:
        ...
        *   Extract each distinct handwritten item as a subitem. Each subitem should have a 'title'. Focus on clear, actionable titles for these items. Ignore unrelated drawings or text.

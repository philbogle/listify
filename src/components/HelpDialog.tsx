...
const HelpDialog: FC<HelpDialogProps> = ({ isOpen, onOpenChange }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md md:max-w-lg flex flex-col max-h-[85vh]"> {/* Changed to flex layout with max-height */}
        <div className="overflow-y-auto flex-grow"> {/* Scrollable area for header and content */}
          <DialogHeader>
          ...
          <div className="mt-4 space-y-5 text-sm"> {/* Removed pr-2 as scrollbar is on parent now */}
        ...
        <DialogFooter className="pt-4 border-t flex-shrink-0"> {/* Added pt-4, border-t, and flex-shrink-0 */}
          <DialogClose asChild>

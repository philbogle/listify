...
const ListCard: FC<ListCardProps> = ({
  ...
  const handleGenerateShareLink = async () => {
    ...
    try {
      ...
      if (newShareId && typeof window !== 'undefined') {
        ...
        // The list object itself will be updated by the useLists hook, triggering a re-render
      } else if (!newShareId) {
  ...
  const handleStopSharing = async () => {
    ...
    try {
      ...
      setShareLinkValue("");
      // The list object will be updated by useLists hook, clearing list.shareId
    } catch (error) {
            ...
            {isEditing ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem onClick={handleOpenShareDialog} disabled={list.completed}>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {list.shareId
                ...
                : "Generate a public link to share this list. Anyone with the link can view and edit it."}
            </DialogDescription>
          </DialogHeader>

...
interface ListCardProps {
  ...
  onScanMoreItemsRequested: (listId: string, listTitle: string) => void; // Prop signature remains the same
                ...
                <DropdownMenuContent align="end">
                  ...
                  {list.scanImageUrls && list.scanImageUrls.length > 0 && onViewScan && (
                   ...
                   <DropdownMenuItem
                    ...
                    disabled={list.completed || (!isUserAuthenticated && list.scanImageUrls && list.scanImageUrls.length > 0) } 
                  >

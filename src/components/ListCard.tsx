...
const ListCard: FC<ListCardProps> = ({
  ...
  const openAutogenerateDialog = () => {
    if (!isUserAuthenticated) {
      toast({ title: "Sign In Required", description: "Please sign in to use AI features.", variant: "destructive" });
      return;
    }
                ...
                <DropdownMenuContent align="end">
                  ...
                  {list.scanImageUrls && list.scanImageUrls.length > 0 && onViewScan && (
                   ...
                   <DropdownMenuItem
                    ...
                    disabled={list.completed || (!isUserAuthenticated && list.scanImageUrls && list.scanImageUrls.length > 0) } // Disable if not auth and already has scans (as new scans won't save for anon)
                  >
                  ...
                  {((list.scanImageUrls && list.scanImageUrls.length > 0) || !list.completed || isUserAuthenticated) && <DropdownMenuSeparator />}
                  <DropdownMenuItem
                    onClick={openAutogenerateDialog}
                    disabled={isGeneratingItems || list.completed || !isUserAuthenticated}
                  >
                    {isGeneratingItems ? (
      ...
      <Dialog open={isAutogenerateDialogOpen} onOpenChange={setIsAutogenerateDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter a prompt for the AI to generate items. This feature requires you to be signed in.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button type="button" onClick={handleConfirmAutogenerate} disabled={isGeneratingItems || !isUserAuthenticated}>

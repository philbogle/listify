...
*   **Dictate or Paste Text:** Use your mobile device's keyboard dictation or paste text into a dialog using the 'Dictate or Paste' feature; AI then converts it to a structured list.
...
*   **Multiple Scan Viewing:** Save and view multiple scanned images per list with zoom functionality (requires sign-in to persist images and for owner to view).
...
*   **List Sharing & Collaboration:** Signed-in users can share lists via a public link, allowing anyone with the link to view and edit the list collaboratively in real-time.
